class Sprite{
  constructor({pos, velocity, image, ctx, frames = {width:1, height:1}}) {
    this.pos = pos //[x,y]
    this.image=image
    this.ctx = ctx
    ...
    this.width = this.image.width/this.frames.width
    this.height = this.image.height/this.frames.height
  }
